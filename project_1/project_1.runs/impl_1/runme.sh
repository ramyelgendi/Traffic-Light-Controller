...
HD_PWD='C:/Users/karenkhafagy/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cycle_basic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cycle_basic.tcl -notrace
