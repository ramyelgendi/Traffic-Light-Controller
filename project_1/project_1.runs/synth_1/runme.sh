...
HD_PWD='C:/Users/karenkhafagy/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cycle_basic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cycle_basic.tcl
